...
document.addEventListener('click', async function(e) {
  console.log('🔍 Click detected on:', e.target.tagName, e.target.getAttribute('data-testid'), e.target);
  ...
  console.log('🔍 Button detection results:', { 
    ...
    unlikeButtonElement: unlikeButton 
  });
  
  if (likeButton) {
    console.log('✅ LIKE BUTTON DETECTED! Processing like action...', likeButton);
    ...
    console.log('✅ UNLIKE BUTTON DETECTED! Processing unlike action...', unlikeButton);
    ...
    console.log('ℹ️ Click not on like/unlike button');
  }
});
